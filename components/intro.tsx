...
import { BsArrowRight, BsFacebook, BsWhatsapp } from "react-icons/bs";
...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, TOGB.</span> Is a{" "}
        <span className="font-bold">
          Full-Stack Web and AI Chatbot Designing company
        </span>{" "}
        with <span className="font-bold">3 years</span> of experience. We enjoy
        building{" "}
        <span className="italic">
          Websites, Chatbots and Conversation flows
        </span>{" "}
        for our clients to solve their business needs and increase leads with
        our focus on{" "}
        <span className="font-bold">
          AI Virtual Assistants and Customer Support.
        </span>
      </motion.h1>
      ...
      >
        ...
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.12rem] rounded-full 
